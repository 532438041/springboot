...
public class ToolsUtil {
     ...
     */
    private static ThreadLocal<Map<String, NumberFormat>> NUMBER_MAP_LOCAL = new ThreadLocal<>();
     ...
     * 判断是否是整型数字，包括负数
     */
    private static final Pattern PATTERN__INT = Pattern.compile("^[-]?[\\d]+$");
    ...
    public static boolean isInt(String str) {
        ...
        Matcher m = PATTERN__INT.matcher(str);
        return m.matches();
    }
     ...
     * 判断是否是手机的正则表达式
     */
    private static final Pattern PATTERN__MOBILE = Pattern.compile("^1[0-9]{10}$");
    ...
    public static boolean isMobile(String str) {
        ...
        Matcher m = PATTERN__MOBILE.matcher(str);
        return m.matches();
    }
     ...
     * 判断是否是数字的正则表达式
     */
    private static final Pattern PATTERN__NUMBER = Pattern.compile("\\d+");
    ...
    public static boolean isNumber(String str) {
        ...
        Matcher m = PATTERN__NUMBER.matcher(str);
        return m.matches();
    }
     ...
     * 判断是否是日期的正则表达式
     */
    private static final Pattern PATTERN__DATE = Pattern.compile("^[0-9]{4}-[0-9]{2}-[0-9]{2}$");
    ...
    public static boolean isDate(String str) {
        ...
        Matcher m = PATTERN__DATE.matcher(str);
        return m.matches();
    }
     ...
     */
    private static final Pattern PATTERN__DATE_TIME = Pattern.compile("^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$");
    ...
    public static boolean isDateTime(String str) {
        ...
        Matcher m = PATTERN__DATE_TIME.matcher(str);
        return m.matches();
    }
    ...
    public static void formatDoubleField(Object o) {
        ...
        Map<String, Double> getFieldMap = new HashMap<>();
        Map<String, Double> setFieldMap = new HashMap<>();
        for (Field field : o.getClass().getDeclaredFields()) {
            String fileType = field.getType().toString().toLowerCase();
            if ("double".equals(fileType)) {
                try {
